...
namespace PhantomExe.Protector
{
    public partial class Protector
    {
        ...
        private void InjectStubImplementation(ModuleDefinition module)
        {
            ...
            // Load the Stub assembly and copy its IVMRuntime type
            ...
            TypeDefinition sourceType, TypeDefinition targetType)
        {
            ...
            else if (operand is IMethodDefOrRef method)
            {
                ...
                {
                    var targetMethod = targetType.Methods.FirstOrDefault(m => m.Name == method.Name);
            ...
            else if (operand is MemberSignature memberSig)
            {
                operand = targetModule.DefaultImporter.ImportMethodSignature(memberSig as MethodSignature);
            }
